    ...
    <header className="relative overflow-hidden px-5 pb-16 pt-14 md:px-8 md:pb-24 md:pt-20">
      <Parallax speed={0.06} className="mx-auto flex max-w-3xl flex-col items-center text-center">
        <img
          ...
          width={56}
          height={56}
          className="hero-enter hero-avatar-float mb-8 h-14 w-14 rounded-full object-cover object-top ring-2 ring-white/10 transition-shadow duration-300 hover:ring-[#FF5733]/40 hover:shadow-[0_0_28px_rgba(255,87,51,0.25)]"
        />
